...
title_template = PromptTemplate(
    ...
    template='analyze the Eductaion skills of this resume {profile}'
)
title_template2 = PromptTemplate(
    input_variables = ['skills'],
    template='based on these analyzed Education {skills} what educational refrence check questions should be asked according to the requiremnet of this job description' + promptJD
)
