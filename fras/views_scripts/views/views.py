...
def cam_in():
    ...
    while cap.isOpened():
        ...
        # cv2.line(fram, (160, 120), (625, 120), (0, 255, 255), edge_thickness)
        cv2.rectangle(fram, (420, 225), (1900, 1050), (0, 255, 0), 2)

        # points = np.array([(420, 225), (1900, 225), (1900, 1050), (550, 1050)], np.int32)
        # points = points.reshape((-1, 1, 2))
        # cv2.polylines(fram, [points], isClosed=True, color=(0, 255, 0), thickness=2)
